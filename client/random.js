...
function gen_cards(settings){
  ...
  for (var prop in settings.color) {
    for (var i = 0; i < settings.color[prop]; i++) {
      color.push(prop);
    }
  }
  shuffle(color);
